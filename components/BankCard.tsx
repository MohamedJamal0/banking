  ...
  return (
    <div className="flex flex-col">
      <Link
        ...
        className="relative flex justify-between h-[190px] w-full max-w-[320px]  rounded-[20px] border border-white bg-bank-gradient shadow-creditCard backdrop-blur-[6px]"
      >

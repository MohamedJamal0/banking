...
export const signUpFormSchema = z.object({
  ...
  state: z
    .string()
    .min(2, { message: 'State code must be 2 characters long' })
    .max(2, { message: 'State code must be 2 characters long' }),
  postalCode: z
    .string()
  ...
  ssn: z.string().min(3, { message: 'SSN must be at least 3 characters long' }),
